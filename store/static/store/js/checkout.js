...
const phoneField = document.getElementById('phone_checkout');
const prefix = '+38 ';
const operatorCodes = [
...
phoneField.addEventListener("input", function() {
    ...
    const formSubmitElement = document.getElementById('submit_form');
    let error = document.getElementById("cphone_checkout")
    if (!operatorCodes.includes(code) && code.length === 3){
        phoneField.classList.add("error");
        error.innerHTML = 'Code ' + code.toString() + ' is not a valid operator code';
